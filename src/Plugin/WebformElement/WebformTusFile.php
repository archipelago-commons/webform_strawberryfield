...
class WebformTusFile extends WebformManagedFileBase {
 ...
 // This should just go into the theme preprocess function.
      ...
      <h3>Uploads</h3>
      <p class="tus-upload-list">Succesful uploads will be listed here. Try one!</p>'
    ];
  ...
  protected function getMaxFileSize(array $element) {
    // @TODO override this so we can upload, thanks to TUS files larger than the actual max upload.
