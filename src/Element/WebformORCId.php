...
/**
 * Provides a webform element for OrcID Family/given autocomplete.
 *
 * @FormElement("webform_metadata_orcid")
 */
class WebformORCId extends WebformCompositeBase {
  ...
  public static function getCompositeElements(array $element) {
    ...
    $class = '\Drupal\webform_strawberryfield\Element\WebformORCId';
    $elements['label'] = [
      '#type' => 'textfield',
      '#title' => t('ORCID Personal Names'),
      '#autocomplete_route_name' => 'webform_strawberryfield.auth_autocomplete',
      '#autocomplete_route_parameters' => ['auth_type' => 'orcid', 'vocab' => $vocab, 'rdftype'=> $matchtype ,'count' => 10],
      '#attributes' => [
        'data-source-strawberry-autocomplete-key' => 'label',
        'data-target-strawberry-autocomplete-key' => 'orcid'
      ],
    ];
  ...
  public static function processWebformComposite(&$element, FormStateInterface $form_state, &$complete_form) {
    ...
    $element['label']["#autocomplete_route_parameters"] =
      ['auth_type' => 'orcid', 'vocab' => $vocab, 'rdftype'=> $matchtype ,'count' => 10];
  ...
  public static function processAutocomplete(&$element, FormStateInterface $form_state, &$complete_form) {
    ...
    $element['#attributes']['data-strawberry-autocomplete'] = 'orcid';
    return $element;
  }
